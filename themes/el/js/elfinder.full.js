 ...
 * Version 2.1.42 (2.1-src Nightly: 76c0b4a) (2018-10-02)
 * http://elfinder.org
 *
 ...
 * @type String
 **/
elFinder.prototype.version = '2.1.42 (2.1-src Nightly: 76c0b4a)';
...
elFinder.prototype.commands.quicklook.plugins = [
	...
	function(ql) {
			...
			navi    = ql.navbar,
			urls    = {
				g: 'docs.google.com/viewer?url=',
				m: 'docs.google.com/viewer?url='
			},
			navBottom = {
				g: '56px',
				m: '24px'
				...
				if (file.size <= 26214400 && (type = mimes[file.mime])) {
					...
					if (file.url !== '' && file.url != '1') {
						...
						node = $('<iframe class="elfinder-quicklook-preview-iframe"/>')
							...
							.attr('src', 'https://' + urls[type] + encodeURIComponent(url)+'&embedded=true');
