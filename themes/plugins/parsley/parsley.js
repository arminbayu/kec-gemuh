...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  defaultMessage: par_defaultMessage,
  type: {
    email:        par_email,
    url:          par_url,
    number:       par_number,
    integer:      par_integer,
    digits:       par_digits,
    alphanum:     par_alphanum
  },
  notblank:       par_notblank,
  required:       par_required,
  pattern:        par_pattern,
  min:            par_min,
  max:            par_max,
  range:          par_range,
  minlength:      par_minlength,
  maxlength:      par_maxlength,
  length:         par_length,
  mincheck:       par_mincheck,
  maxcheck:       par_maxcheck,
  check:          par_check,
  equalto:        par_equalto
});
